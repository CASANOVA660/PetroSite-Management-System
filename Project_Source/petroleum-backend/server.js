...
const { shiftRoutes, operationEquipmentRoutes, reportRoutes, progressRoutes, attendanceRoutes } = require('./modules/projectoperation/routes');
...
app.use('/api/projects', progressRoutes);
app.use('/api/projects', attendanceRoutes);
