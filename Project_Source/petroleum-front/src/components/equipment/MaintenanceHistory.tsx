...
const MaintenanceHistory: React.FC<MaintenanceHistoryProps> = ({ history, isLoading }) => {
    ...
    // Filter history entries by type "maintenance"
    const maintenanceHistory = history.filter(entry => entry.type === 'maintenance');
    ...
    }, [maintenanceHistory, dateFilter, startDate, endDate, searchTerm]);
    ...
    return (
        <div className="space-y-4">
            ...
            {isLoading ? (
                ...
                <EmptyHistoryState
                    message="Aucun enregistrement de maintenance n'a été trouvé pour cet équipement."
                />
            )}
        </div>
    );
