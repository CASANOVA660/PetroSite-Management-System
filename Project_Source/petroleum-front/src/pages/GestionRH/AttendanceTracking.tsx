...
const AttendanceTracking: React.FC = () => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            const mockEmployees: Employee[] = [
                { _id: 'e1', name: 'Ahmed Benaissa', position: 'Engineer', department: 'Operations' },
                { _id: 'e2', name: 'Mohammed Khaldi', position: 'Technician', department: 'Maintenance' },
                { _id: 'e3', name: 'Sara Mourad', position: 'HR Specialist', department: 'Human Resources' },
                { _id: 'e4', name: 'Karim Benzema', position: 'Geologist', department: 'Exploration' },
                { _id: 'e5', name: 'Fatima Zahra', position: 'Accountant', department: 'Finance' },
            ];
    ...
    return (
        <div className="space-y-6">
            ...
            <ComponentCard title="Pointage Journalier" className="shadow-lg">
